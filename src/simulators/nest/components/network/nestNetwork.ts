...
export class NESTNetwork extends BaseNetwork {
  ...
  override get project(): NESTProject {
    return this.parent as NESTProject;
  }

  override get nodes(): NESTNodes {
    return this.nodesAllTypes as NESTNodes;
  }
