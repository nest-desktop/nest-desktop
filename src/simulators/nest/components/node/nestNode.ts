...
import { NodeRecord, NodeRecordProps } from "@/components/node/nodeRecord";
...
} from "./nodeCompartment/nestNodeCompartment";
import {
  NESTNodeReceptor,
  NESTNodeReceptorProps,
} from "./nodeReceptor/nestNodeReceptor";
import {
  NESTNodeSpatial,
...
export class NESTNode extends BaseNode {
  ...
  get nestModel(): NESTModel {
    return this.model as NESTModel;
  }
  ...
  override get nodes(): NESTNodes {
    return this.parent as NESTNodes;
  }
