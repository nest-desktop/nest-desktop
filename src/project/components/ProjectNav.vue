...
import { getCurrentDBStore, getCurrentStore, useAppStore } from "@/app";
import { truncate } from "@/utils";
import { useNavStore } from "@/nav";

import ProjectMenu from "./ProjectMenu.vue";
import { newProjectRoute } from "../routes";
...
const projects = computed(() =>
  projectDBStore.state.projects.filter((project: TProject) =>
...
const items = [
  ...
  {
    onClick: () => projectDBStore.updateList(),
...
const saveProject = (project: TProject) => {
  projectDBStore.saveProject(project);
