...
export class NodeGraphConnector extends BaseObj {
  ...
  init(selector: TSelection): void {
    ...
    const dragging: TDragBehavior = drag()
      ...
      .on("drag", (e: MouseEvent, n: TNodeGroup | TNode | unknown) => this.drag(e, n as TNodeGroup | TNode))
    ...
    connectorEnd
      ...
      .on("click", (e: MouseEvent, n: TNodeGroup | TNode) => {
        this.drag(e, n);
        this.render();
      })
      .call(dragging, null);
  ...
  render(): void {
    ...
    connector
      ...
      .style("opacity", (n: TNodeGroup | TNode) => (n.view.isFocused && !connectionDrag ? "1" : "0"));
    ...
    connector
      ...
      .attr(
        "d",
        (
          n: TNodeGroup | TNode | any, // TODO: no any!
    ...
    connector
      .select(".end")
      .transition(t)
      .attr("transform", (n: TNodeGroup | TNode) =>
