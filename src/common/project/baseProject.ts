...
import { ActivityGraph } from "@/graph/activityGraph/activityGraph";
import { BaseNetwork, NetworkProps } from "../network/baseNetwork";
import { ProjectState } from "./projectState";
import { BaseSimulation, SimulationProps } from "../simulation/baseSimulation";
...
export class BaseProject {
  ...
  newNetwork(data?: NetworkProps): BaseNetwork {
    return new BaseNetwork(this, data);
  }

  newSimulation(data?: SimulationProps): BaseSimulation {
