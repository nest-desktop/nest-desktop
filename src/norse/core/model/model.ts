...
export class Model extends NorseConfig {
  ...
  /**
   * Get parameter defaults of a model from Norse Simulator.
   */
  // async fetchDefaults(): Promise<any> {
  //   return this._app.backends.norseSimulator.instance.post("api/GetDefaults", {
  //     model: this._id,
  //   });
  // }
