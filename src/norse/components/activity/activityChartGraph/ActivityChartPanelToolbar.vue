...
import { ActivityChartPanel } from "@norse/graph/activityGraph/activityChart/activityChartPanel";
import ActivityChartPanelMenuPopover from "@norse/components/activity/activityChartGraph/ActivityChartPanelMenuPopover.vue";
