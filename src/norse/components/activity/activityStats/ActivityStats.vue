...
import NodeAvatar from "@norse/components/node/avatar/NodeAvatar.vue";
import { AnalogSignalActivity } from "@norse/core/activity/analogSignalActivity";
import { SpikeActivity } from "@norse/core/activity/spikeActivity";
