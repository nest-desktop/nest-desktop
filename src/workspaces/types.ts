...
export type TModelState = nest.INESTModelState;
...
export type TProjectState = nest.INESTProjectState | norse.INorseProjectState;
export type TSimulation = nest.NESTSimulation | norse.NorseSimulation;
