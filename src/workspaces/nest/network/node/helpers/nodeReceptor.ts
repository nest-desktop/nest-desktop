...
import { NodeParameters, type INodeRecordState, type NodeView } from "@/network";

import type { NESTModelReceptor } from "../../../model";
import type { NESTNode } from "../node";
import type { NESTNodeCompartment } from "./nodeCompartment";
