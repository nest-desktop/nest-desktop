...
import { NetworkGraphContent } from "@/networkGraph/components";
import { mountNetworkGraph, unmountNetworkGraph } from "@/networkGraph";

import { NESTNetworkGraph } from "../networkGraph";
...
onMounted(() => mountNetworkGraph(new NESTNetworkGraph(networkGraphRef, network.value)));
