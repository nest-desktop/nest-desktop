<template>
  <v-card>
    ...
    <v-card-text>
      <v-text-field v-model="state.toImageButtonOptions.filename" density="compact" label="filename" />

      <v-row>
        <v-col cols="6">
          <v-text-field v-model="state.toImageButtonOptions.width" density="compact" label="width">
            <template #prepend> size: </template>
          </v-text-field>
        </v-col>
        <v-col cols="6">
          <v-text-field v-model="state.toImageButtonOptions.height" density="compact" label="height">
    ...
    <v-card-actions>
      <v-spacer />
      <v-btn text="download" @click="closeDialog(state.toImageButtonOptions)" />
