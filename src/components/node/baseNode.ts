...
import { AnalogSignalActivity } from "@/components/activity/analogSignalActivity";
import { ModelParameter } from "@/components/model/modelParameter";
import { SpikeActivity } from "@/components/activity/spikeActivity";
...
export class BaseNode extends Config {
   ...
   */
  clean(): void {
    const nodes = this.nodes.all as BaseNode[]
