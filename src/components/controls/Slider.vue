<template>
  <RangeSlider v-if="props.options.component === 'rangeSlider'" v-bind="props.options" v-model="modelValue" />
  <TickSlider v-else-if="props.options.component === 'tickSlider'" v-bind="props.options" v-model="modelValue" />
