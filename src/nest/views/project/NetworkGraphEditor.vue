...
const state = reactive({
  graph: new NetworkGraph(networkGraph, projectStore.project.network as Network),
});

onMounted(() => {
  state.graph = new NetworkGraph(networkGraph, projectStore.project.network as Network);
